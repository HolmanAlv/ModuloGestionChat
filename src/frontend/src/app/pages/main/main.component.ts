...
export class MainComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  // Replace with your own user identification logic
  ...
  logout() {
    ...
    // For example, clear local storage and redirect
    // localStorage.clear();
    // window.location.href = '/login';
  }

  userProfile() {
    // Implement your own profile logic here
  ...
  private initWebSocket() {
    ...
    const subUrl = `/user/${this.userId}/chat`;
